...
insert into `testDB`.`users` (`uid`, `fname`, `lname`, `loginpw`)
...
INSERT INTO `testDB`.`locations` (`name`, `address`, `street`, `num_stars`, 
	`password`, `phone`, `verified`) VALUES ('Arbys', '180', 'Hendersonville Rd', '1', 'none',
    '828 298 8804',0);
    
INSERT INTO `testDB`.`locations` (`name`, `address`, `street`, `num_stars`, 
	`password`, `phone`, `verified`) VALUES ('Arbys', '1350', 'Tunnel Rd', '3', 'none', 
    '828 258 1557', 0);  

insert into `testDB`.`locations` (`name`, `address`, `street`, `num_stars`, 
	`password`, `phone`, `verified`) VALUES ('Asheville Pizza & Brewing Co.', 
    '675', 'Merrimon Ave', '2', 'none', 
    '828-254-1281', 0);  
    
insert into `testDB`.`locations` (`name`, `address`, `street`, `num_stars`, 
	`password`, `phone`, `verified`) VALUES ('Bojangles', 
